...
namespace RecipeAZ.Migrations
{
    ...
    [Migration("20230422051553_AddSubRecipes")]
    partial class AddSubRecipes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeAZ.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "03a2a352-58a9-4cc8-995f-46c5dce7e3ce",
                            Email = "admin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAEAqsH3EFvkD8Weg7tIyE4c4/ZFMTfJ6JJFS+BSthtvRHkIR3CnY1pFClohr7M1g//g==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c9fbc6bd-a954-4ad4-aee3-bb1613c23ce8",
            ...
            modelBuilder.Entity("RecipeAZ.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommentId = "1",
                            CreatedAt = new DateTime(2023, 4, 21, 22, 15, 53, 60, DateTimeKind.Local).AddTicks(1005),
                            RecipeId = "1",
                            Text = "nice recipe",
                            UserId = "02174cf0–9412–4cfe - afbf - 59f706d72cf6"
                        });
            ...
            modelBuilder.Entity("RecipeAZ.Models.Recipe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RecipeId = "1",
                            CreatedAt = new DateTime(2023, 4, 21, 22, 15, 53, 59, DateTimeKind.Local).AddTicks(9062),
            ...
            modelBuilder.Entity("RecipeAZ.Models.SubRecipe", b =>
                {
                    b.Property<string>("SubRecipeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RecipeAZ.Models.RecipeStep", b =>
                {
                    ...
                    b.HasOne("RecipeAZ.Models.SubRecipe", "SubRecipe")
                        .WithMany("RecipeSteps")
